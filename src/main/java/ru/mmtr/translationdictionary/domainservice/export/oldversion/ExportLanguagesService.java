...
public class ExportLanguagesService {
    ...
    private static final String LANGUAGES_FILE_PATH = "C:\\Users\\parinos.ma.kst\\IdeaProjects\\" +
    ...
    public MultipartFile getExportLanguage(UUID id) {
        try {
            ...
            return new MockMultipartFile("C:/Users/parinos.ma.kst/IdeaProjects/" +
                    "translation-dictionary/src/main/resources/export/languages", file.getName(),
